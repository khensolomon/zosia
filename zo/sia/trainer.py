...
#
# What it does:
# This module's Trainer class has been updated to use a configurable optimizer
# and to apply gradient clipping, which prevents the "nan" loss error and
...
class Trainer:
    ...
    def save_checkpoint(self, filename, input_lang, output_lang, max_length):
